...
<head> 
	...
	<script src="<?php echo $base;?>scripts/login.js"></script>
</head>
	<body>
		<div>
			<div class=".container">
		...
		<div>
			<form class="form-horizontal form-horizontal-small"id="submit">
				<!--<legend>
					...
					<div class="alert">Please Login<span style="padding:0 0 0 20px;">管理员默认用户名:admin,默认密码:admin,用户可注册</span></div>
					<div>
						...
						<div class="control-group">
							<div class="controls">
								...
								<div id="login" class="btn btn-primary">
									<i class="icon-user icon-white"></i>
									<a href="<?php echo $base?>index.php/revise"style="color:white;">修改密码?</a>
								</div>
