...
<head> 
	...
	<script src="<?php echo $base;?>scripts/revise.js"></script>
</head>
	<body>
		<div>
			<div class=".container">
		...
		<div>
			<form class="form-horizontal form-horizontal-small"id="submit">
				<!--<legend>
					...
					<div class="alert">修改密码<span style="padding:0 0 0 20px;">系统默认旧密码:demo</span></div>
					<div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input  type="password" name="password" id="password" placeholder="用户名" />
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="password_new">新密码</label>
							<div class="controls">
								<input  type="password" name="password_new" id="password_new" placeholder="新密码" />
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="password_again">再次输入新密码</label>
							<div class="controls">
