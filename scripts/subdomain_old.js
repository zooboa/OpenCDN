...
function query_record() {
	$.post(basePath+"index.php/subdomain/query_dnspod_subdomain",
		...
		function (odata){
			...
			head_column+="<div class='span2'>域名</div>";
			head_column+="<div class='span2'>源站IP</div>";
			head_column+="<div class='span2'>节点IP</div>";
			head_column+="<div class='span2'>线路</div>";
			head_column+="<div class='span1'>切换状态</div>";
			...
			for (i=0;i<length;i++) {
				...
				data_column+="<div class='span2'>"+odata[i].sub_domain+"</div>";
				data_column+="<div class='span2'>"+odata[i].domain_ip+"</div>";
				data_column+="<div class='span2'>"+odata[i].node_ip+"</div>";
				data_column+="<div class='span2'>"+odata[i].record_line+"</div>";
				data_column+="<div class='span1'>...</div>";
				...
				data_column+="<a role='button' class='btn btn-primary' href='javascript:remove_record("+odata[i].record_id+",\""+odata[i].sub_domain+"\");'>删除</a></div></div>";
